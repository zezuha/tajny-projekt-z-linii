package secretLines.parts.human;

import secretLines.parts.movie.BasicMoviePart;
...
public class Human3Part extends BasicMoviePart {
    ...
    public Human3Part(PApplet parent) {
